...
for i in range(0,len(data)):
    ...
    temp2=temp#cv2.resize(temp, dsize=(2278, 2278))
    ...
    image=ndimage.binary_dilation(image, structure=struct1,iterations=4).astype(image.dtype)
    image=ndimage.filters.gaussian_filter(image, sigma = 4, order = 0)
    ...
    print ("hello babak")
    cv2.imwrite('/home/babak/Desktop/WPAFB2009/AOI42/Heatmaps/test/'+"GT_cropImage"+str(10100+i)+'.pbm',image*255)#image*255)
